...
[`thehonestdog_get_svg( $args = array() ); // Return SVG markup`](../../blob/master/inc/template-tags.php#L125) 
```
/**
 * Return SVG markup.
 *
...
Example usage:
`<?php echo thehonestdog_get_svg( 'twitter'); ?>`
...
```
[`thehonestdog_do_svg( $icon_name ); // Echo SVG markup`](../blob/master/inc/template-tags.php#L139)

Example usage: 
`<?php thehonestdog_do_svg( 'facebook' ); ?>`
